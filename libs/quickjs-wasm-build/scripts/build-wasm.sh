...
BASE_EMCC_FLAGS=(
  ...
  -sWASM_BIGINT=1
  "-sEXPORTED_FUNCTIONS=['_qjs_eval','_qjs_det_init','_qjs_det_eval','_qjs_det_free','_qjs_det_enable_tape','_qjs_det_read_tape','_qjs_det_enable_trace','_qjs_det_read_trace','_qjs_free_output','_malloc','_free']"
