...
assert_output "Promise compat-general gas+tape" "(() => Promise.resolve(40).then((value) => value + 2))()" "RESULT 42 GAS remaining=49287 used=713 TAPE []" --execution-profile compat-general-v1 --gas-limit 50000 --report-gas --report-tape
assert_output "queueMicrotask host-call gas+tape" "(() => { queueMicrotask(() => Host.v1.emit({ phase: 'microtask' })); return Promise.resolve({ ok: true }); })()" "RESULT {\"ok\":true} GAS remaining=49170 used=830 TAPE [{\"fnId\":3,\"reqLen\":18,\"respLen\":12,\"units\":0,\"gasPre\":\"23\",\"gasPost\":\"0\",\"isError\":false,\"chargeFailed\":false,\"reqHash\":\"7c833f34b57bfcb9b78c49448e0506baec6e0cc31aecf5af02f6a8f24bb53fec\",\"respHash\":\"d4a80d0e37c72d337ea29cff53628612f13bd4d5269b86f393a02759d60307c0\"}]" --execution-profile compat-general-v1 --gas-limit 50000 --report-gas --report-tape
assert_output "Promise rejection deterministic error" "(() => Promise.reject(new Error('async-failure')))()" "ERROR Error: async-failure GAS remaining=49408 used=592 TAPE []" --execution-profile compat-general-v1 --gas-limit 50000 --report-gas --report-tape
